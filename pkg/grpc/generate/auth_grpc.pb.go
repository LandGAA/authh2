...
const (
	UserService_CheckToken_FullMethodName  = "/proto.UserService/CheckToken"
...
type UserServiceClient interface {
	CheckToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*UserResponse, error)
...
func (c *userServiceClient) CheckToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
type UserServiceServer interface {
	CheckToken(context.Context, *TokenRequest) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) CheckToken(context.Context, *TokenRequest) (*UserResponse, error) {
...
func _UserService_CheckToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).CheckToken(ctx, req.(*TokenRequest))
	}
